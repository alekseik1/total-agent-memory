"""Regression test for migrations/033_reflection_report_stat_names.sql.
...
`new_nodes=116176`, which is strengthened graph edges, not new nodes. 033
...
MIGRATION_SQL = (
    ROOT / "migrations" / "033_reflection_report_stat_names.sql"
).read_text()


def _pre_033_db() -> sqlite3.Connection:
    """A `reflection_reports` table shaped as migrations 001-032 left it."""
